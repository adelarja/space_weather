function [Bx_nube,By_nube,Bz_nube,date,theta,phi,R,Bx_nube_ext,By_nube_ext,Bz_nube_ext,date_ext,eval1,eval2,eval3,evec1,evec2,evec3,cociente,cocientefrente,cocienteback,valordelafechaenc]=llamocalculocentro(DIR_WORK,dir_,Vsw,initial_date,end_date,initial_date_mv,end_date_mv,graf,gap,normalized,kind_mv,initial_date_graf,end_date_graf,file_mfi_,valordelafechaenfrente,valordelafechaenback,jj)
%
