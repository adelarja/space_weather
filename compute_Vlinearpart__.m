function[delta_t,deltat,MCsize,MCsizepartelineal,sigma,travel_time_,travel_timepartelineal,Vfit_center,coef_l,coef_lpartelineal,dV_fit_nube,dV_fit_partelineal,mean_distance_to_sun,Pears_datos_,Vc_centropartelineal,a,b,vantes,vdespues]=compute_Vlinearpart(Vr,d,date_,date_ini,date_end,AU,flag_graf,flag_sat,nMC,distance_to_sun,DIR_WORK,date_ini_new,date_end_new,quality,overtak)
...
switch nMC
    case 1
    text(x1,y1,strcat('coef l=',{' '},num2str(coef_lpartelineal,3),' Vc=',{' '},num2str(Vc_centropartelineal),' M3size=',{' '},num2str(MCsizepartelineal),' T=',{' '},num2str(travel_timepartelineal),' Nopert %=',{' '},num2str((deltat/delta_t)*100,3)))
case 2
    text(x1,665,strcat('coef l=',{' '},num2str(coef_lpartelineal,3),' Vc=',{' '},num2str(Vc_centropartelineal),' M3size=',{' '},num2str(MCsizepartelineal),' T=',{' '},num2str(travel_timepartelineal),' Nopert %=',{' '},num2str((deltat/delta_t)*100,3)))

    case 3
  text(x1,y1,strcat('coef l=',{' '},num2str(coef_lpartelineal,3),' Vc=',{' '},num2str(Vc_centropartelineal),' M3size=',{' '},num2str(MCsizepartelineal),' T=',{' '},num2str(travel_timepartelineal),' pert %=',{' '},num2str((deltat/delta_t)*100,3)))
...
text(x1,y1,strcat('coef l=',{' '},num2str(coef_lpartelineal,3),' Vc=',{' '},num2str(Vc_centropartelineal),' M3size=',{' '},num2str(MCsizepartelineal),' T=',{' '},num2str(travel_timepartelineal),' Nopert %=',{' '},num2str((deltat/delta_t)*100,3)))
    ...
    case 7
    text(x1,400,strcat('coef l=',{' '},num2str(coef_lpartelineal,3),' Vc=',{' '},num2str(Vc_centropartelineal),' M3size=',{' '},num2str(MCsizepartelineal),' T=',{' '},num2str(travel_timepartelineal),' Nopert %=',{' '},num2str((deltat/delta_t)*100,3)))
    case 8
    text(x1,y1,strcat('coef l=',{' '},num2str(coef_lpartelineal,3),' Vc=',{' '},num2str(Vc_centropartelineal),' M3size=',{' '},num2str(MCsizepartelineal),' T=',{' '},num2str(travel_timepartelineal),' Nopert %=',{' '},num2str((deltat/delta_t)*100,3)))
  case 9
    text(x1,530,strcat('coef l=',{' '},num2str(coef_lpartelineal,3),' Vc=',{' '},num2str(Vc_centropartelineal),' M3size=',{' '},num2str(MCsizepartelineal),' T=',{' '},num2str(travel_timepartelineal),' Nopert %=',{' '},num2str((deltat/delta_t)*100,3)))
  case 10
    text(x1,y1,strcat('coef l=',{' '},num2str(coef_lpartelineal,3),' Vc=',{' '},num2str(Vc_centropartelineal),' M3size=',{' '},num2str(MCsizepartelineal),' T=',{' '},num2str(travel_timepartelineal),' Nopert %=',{' '},num2str((deltat/delta_t)*100,3)))
    case 11
    text(x1,510,strcat('coef l=',{' '},num2str(coef_lpartelineal,3),' Vc=',{' '},num2str(Vc_centropartelineal),' M3size=',{' '},num2str(MCsizepartelineal),' T=',{' '},num2str(travel_timepartelineal),' Nopert %=',{' '},num2str((deltat/delta_t)*100,3)))
    case 12
    text(x1,y1,strcat('coef l=',{' '},num2str(coef_lpartelineal,3),' Vc=',{' '},num2str(Vc_centropartelineal),' M3size=',{' '},num2str(MCsizepartelineal),' T=',{' '},num2str(travel_timepartelineal),' Nopert %=',{' '},num2str((deltat/delta_t)*100,3)))
 
    case 13
     %text(x1,y1,strcat('coef l=',{' '},num2str(coef_lpartelineal,3),' Vc=',{' '},num2str(Vc_centropartelineal),' M3size=',{' '},num2str(MCsizepartelineal),' T=',{' '},num2str(travel_timepartelineal),' pert %=',{' '},num2str((deltat/delta_t)*100,3)))
     text(x1,y1,strcat('coef l=',{' '},num2str(coef_lpartelineal,3),' Vc=',{' '},num2str(Vc_centropartelineal),' M3size=',{' '},num2str(MCsizepartelineal),' T=',{' '},num2str(travel_timepartelineal),' pert %=',{' '},num2str(100)))
case 14
      text(x1,510,strcat('coef l=',{' '},num2str(coef_lpartelineal,3),' Vc=',{' '},num2str(Vc_centropartelineal),' M3size=',{' '},num2str(MCsizepartelineal),' T=',{' '},num2str(travel_timepartelineal),' pert %=',{' '},num2str((deltat/delta_t)*100,3)))

end
  text(x1,y2,strcat('coef correl=',{' '},num2str(Pears_datos(1,2)),' distsun=',{' '},num2str(mean_distance_to_sun),{' '},'q=',num2str(quality),{' '},'ot=',num2str(overtak),'slope in km/sec= ',num2str(Pol(1))))
 %text(x1,y1,strcat('coef l=',{' '},num2str(coef_lpartelineal,3),' Vc=',{' '},num2str(Vc_centropartelineal),' MCsize=',{' '},num2str(MCsizepartelineal),' T=',{' '},num2str(travel_timepartelineal),' Dv=',{' '},num2str(dV_fit_partelineal,3)))
