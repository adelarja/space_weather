function [bx_nube,by_nube,bz_nube,date_,theta,phi,R,bx_nube_ext,by_nube_ext,bz_nube_ext,date_ext,eval1,eval2,eval3,evec1,evec2,evec3,B_,B,coc_,cocientefrente,cocienteback]=min_var_oct09(DIR_WORK,bx_gse_ext_,by_gse_ext_,bz_gse_ext_,date_ext_,Vsw,initial_date,end_date,graf,gap,B__,...
...
%    end
 % if funciondelflujo(indiceminsinmodulo)==funciondelflujo(indicemax)
  ...
  if funciondelflujo(indicemaxsinmodulo)==funciondelflujo(indicemax)
      clear coc_
      coc_=funciondelflujo(end)/funciondelflujo(indicemaxsinmodulo);
   ...
   if funciondelflujo(indiceminsinmodulo)==funciondelflujo(indicemax)
       clear coc_
       coc_=funciondelflujo(end)/funciondelflujo(indiceminsinmodulo);
...
%  plot(fechaenhy(indicedelfinenhy),funciondelflujo_ext1(indicedelfinenhy),'hk','MarkerSize',10)
  ...
  figure
   ...
   ylabel('B_{z,MV} (nT)')
   xlabel(strcat('Time (Hours), after:',datestr(date_ext(cond_graf(1)))))
    print('-depsc',strcat(DIR_WORK(2:end),'BzMV_',num2str(jj)))
  print('-dtiff',strcat(DIR_WORK(2:end),'BzMV_',num2str(jj)))
  ...
  % print('-depsc',strcat(DIR_WORK(2:end),'BxMV'))
   ...
   ylabel('B_{x,MV} (nT)')
   xlabel(strcat('Time (Hours), after:',datestr(date_ext(cond_graf(1)))))
    print('-depsc',strcat(DIR_WORK(2:end),'BxMV',num2str(jj)))
 print('-dtiff',strcat(DIR_WORK(2:end),'BxMV',num2str(jj)))
...
%B
   ...
   ylabel('B (nT)')
   xlabel(strcat('Time (Hours), after:',datestr(date_ext(cond_graf(1)))))
    print('-depsc',strcat(DIR_WORK(2:end),'BMV',num2str(jj)))
print('-dtiff',strcat(DIR_WORK(2:end),'BMV',num2str(jj)))
figure
%By
  plot(fechaenh,funciondelflujo,'-.')
  hold on
...
% hold on
 ...
 hold on
  ...
  print('-depsc',strcat(DIR_WORK(2:end),'ByMV',num2str(jj)))
print('-dtiff',strcat(DIR_WORK(2:end),'ByMV',num2str(jj)))
