function [Bx_nube,By_nube,Bz_nube,date,theta,phi,R,Bx_nube_ext,By_nube_ext,Bz_nube_ext,date_ext,eval1,eval2,eval3,evec1,evec2,evec3,cociente,cocientefrente,cocienteback]=graficopaperaya_(DIR_WORK,dir_,Vsw,initial_date,end_date,graf,gap,normalized,kind_mv,initial_date_graf,end_date_graf,file_mfi_,valordelafechaenfrente,valordelafechaenback,jj,flag_sat)
%
...
[bx_nube,by_nube,bz_nube,date,theta,phi,R,bx_nube_ext,by_nube_ext,bz_nube_ext,date_ext,eval1,eval2,eval3,evec1,evec2,evec3,B_,B,cociente,cocientefrente,cocienteback]=grafico_paper_AyA_(DIR_WORK,bx_gse,by_gse,bz_gse,fecha,Vsw,initial_date,end_date,graf,gap,B,kind_mv,initial_date_graf,end_date_graf,valordelafechaenfrente,valordelafechaenback,jj,flag_sat);
